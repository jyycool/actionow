...
public class ScopeExpansionService {
    ...
    private List<Map<String, Object>> fetchEpisodesByScript(String scriptId) {
        try {
            Result<List<Map<String, Object>>> result = projectLocalClient.listEpisodesByScript(scriptId, null);
    ...
    private List<Map<String, Object>> fetchStoryboardsByEpisode(String episodeId) {
        try {
            Result<List<Map<String, Object>>> result = projectLocalClient.listStoryboardsByEpisode(episodeId, null);
            return result.isSuccess() && result.getData() != null ? result.getData() : Collections.emptyList();
        } catch (Exception e) {
    ...
    private List<Map<String, Object>> fetchCharacters(String scriptId) {
        try {
            Result<List<Map<String, Object>>> result = projectLocalClient.listAvailableCharacters(scriptId, null);
            return result.isSuccess() && result.getData() != null ? result.getData() : Collections.emptyList();
        } catch (Exception e) {
    ...
    private List<Map<String, Object>> fetchScenes(String scriptId) {
        try {
            Result<List<Map<String, Object>>> result = projectLocalClient.listAvailableScenes(scriptId, null);
            return result.isSuccess() && result.getData() != null ? result.getData() : Collections.emptyList();
        } catch (Exception e) {
    ...
    private List<Map<String, Object>> fetchProps(String scriptId) {
        try {
            Result<List<Map<String, Object>>> result = projectLocalClient.listAvailableProps(scriptId, null);
            return result.isSuccess() && result.getData() != null ? result.getData() : Collections.emptyList();
        } catch (Exception e) {
