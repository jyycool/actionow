...
public class TaskRuntimeConfigService extends RuntimeConfigService {
    ...
    /** Task 调用 AI 服务 Local 读取超时时间（毫秒） */
    public static final String AI_FEIGN_READ_TIMEOUT_MS         = "runtime.task.ai_local_read_timeout_ms";
    /**
    ...
    /** Local 连接超时（毫秒） */
    public static final String FEIGN_CONNECT_TIMEOUT_MS         = "runtime.task.client_connect_timeout_ms";
    /** AI 服务 URL */
    ...
    public int getAiLocalReadTimeoutMs() {
    ...
    public int getLocalConnectTimeoutMs() {
