...
import com.actionow.canvas.client.ProjectLocalClient;
...
public class CanvasServiceImpl implements CanvasService {
    ...
    private List<EntityInfo> fetchEntitiesByType(String entityType, List<String> ids) {
        ...
        Result<List<EntityInfo>> result = switch (normalizedType) {
            case CanvasConstants.EntityType.SCRIPT -> projectLocalClient.batchGetScripts(ids);
            case CanvasConstants.EntityType.EPISODE -> projectLocalClient.batchGetEpisodes(ids);
            case CanvasConstants.EntityType.STORYBOARD -> projectLocalClient.batchGetStoryboards(ids);
            case CanvasConstants.EntityType.CHARACTER -> projectLocalClient.batchGetCharacters(ids);
            case CanvasConstants.EntityType.SCENE -> projectLocalClient.batchGetScenes(ids);
            case CanvasConstants.EntityType.PROP -> projectLocalClient.batchGetProps(ids);
            case CanvasConstants.EntityType.ASSET -> projectLocalClient.batchGetAssets(ids);
            default -> null;
        };
