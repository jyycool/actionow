...
import com.actionow.ai.client.ProjectLocalClient;
...
/**
 * 数据库操作绑定（受限白名单控制）
 * 通过 本地客户端调用 Project 微服务来执行数据库操作
...
public class DbBinding {
    ...
    private final ProjectLocalClient projectLocalClient;
    ...
    public DbBinding(ProjectLocalClient projectLocalClient) {
        this.projectLocalClient = projectLocalClient;
    }
    ...
    public Map<String, Object> createScript(Map<String, Object> data) {
        ...
        try {
            Result<Map<String, Object>> result = projectLocalClient.createScript(request);
    ...
    public Map<String, Object> batchCreateScripts(List<Map<String, Object>> scripts) {
        ...
        try {
            Result<List<String>> result = projectLocalClient.batchCreateScripts(requests);
    ...
    public Map<String, Object> updateScript(String scriptId, Map<String, Object> data) {
        ...
        try {
            Result<Void> result = projectLocalClient.updateScript(scriptId, data);
    ...
    public Map<String, Object> deleteScript(String scriptId) {
        ...
        try {
            Result<Void> result = projectLocalClient.deleteScript(scriptId);
            return buildVoidResult(result);
        } catch (Exception e) {
    ...
    public Map<String, Object> batchDeleteScripts(List<String> scriptIds) {
        ...
        try {
            Result<Void> result = projectLocalClient.batchDeleteScripts(scriptIds);
            return buildVoidResult(result);
        } catch (Exception e) {
    ...
    public Map<String, Object> getScript(String scriptId) {
        ...
        try {
            Result<Map<String, Object>> result = projectLocalClient.getScript(scriptId);
            if (result.isSuccess()) {
    ...
    public List<Map<String, Object>> listScripts() {
        ...
        try {
            Result<List<Map<String, Object>>> result = projectLocalClient.listScripts(workspaceId);
            if (result.isSuccess()) {
    ...
    public Map<String, Object> createEpisode(Map<String, Object> data) {
        ...
        try {
            Result<Map<String, Object>> result = projectLocalClient.createEpisode(request);
            return buildResult(result);
        } catch (Exception e) {
    ...
    public Map<String, Object> batchCreateEpisodes(List<Map<String, Object>> episodes) {
        ...
        try {
            Result<List<String>> result = projectLocalClient.batchCreateEpisodes(requests);
            return buildListResult(result);
        } catch (Exception e) {
    ...
    public Map<String, Object> updateEpisode(String episodeId, Map<String, Object> data) {
        ...
        try {
            Result<Void> result = projectLocalClient.updateEpisode(episodeId, data);
            return buildVoidResult(result);
        } catch (Exception e) {
    ...
    public Map<String, Object> deleteEpisode(String episodeId) {
        ...
        try {
            Result<Void> result = projectLocalClient.deleteEpisode(episodeId);
            return buildVoidResult(result);
        } catch (Exception e) {
    ...
    public Map<String, Object> batchDeleteEpisodes(List<String> episodeIds) {
        ...
        try {
            Result<Void> result = projectLocalClient.batchDeleteEpisodes(episodeIds);
            return buildVoidResult(result);
        } catch (Exception e) {
    ...
    public Map<String, Object> getEpisode(String episodeId) {
        ...
        try {
            Result<Map<String, Object>> result = projectLocalClient.getEpisode(episodeId);
            if (result.isSuccess()) {
                return result.getData() != null ? result.getData() : Collections.emptyMap();
            }
            return Collections.emptyMap();
    ...
    public List<Map<String, Object>> getEpisodesByScript(String scriptId) {
        ...
        try {
            Result<List<Map<String, Object>>> result = projectLocalClient.getEpisodesByScript(scriptId);
            if (result.isSuccess()) {
                return limitResults(result.getData());
            }
            return Collections.emptyList();
    ...
    public Map<String, Object> createStoryboard(Map<String, Object> data) {
        ...
        try {
            Result<Map<String, Object>> result = projectLocalClient.createStoryboard(request);
            return buildResult(result);
        } catch (Exception e) {
    ...
    public Map<String, Object> batchCreateStoryboards(List<Map<String, Object>> storyboards) {
        ...
        try {
            Result<List<String>> result = projectLocalClient.batchCreateStoryboards(requests);
            return buildListResult(result);
        } catch (Exception e) {
    ...
    public Map<String, Object> updateStoryboard(String storyboardId, Map<String, Object> data) {
        ...
        try {
            Result<Void> result = projectLocalClient.updateStoryboard(storyboardId, data);
            return buildVoidResult(result);
        } catch (Exception e) {
    ...
    public Map<String, Object> deleteStoryboard(String storyboardId) {
        ...
        try {
            Result<Void> result = projectLocalClient.deleteStoryboard(storyboardId);
            return buildVoidResult(result);
        } catch (Exception e) {
    ...
    public Map<String, Object> batchDeleteStoryboards(List<String> storyboardIds) {
        ...
        try {
            Result<Void> result = projectLocalClient.batchDeleteStoryboards(storyboardIds);
            return buildVoidResult(result);
        } catch (Exception e) {
    ...
    public Map<String, Object> getStoryboard(String storyboardId) {
        ...
        try {
            Result<Map<String, Object>> result = projectLocalClient.getStoryboard(storyboardId);
            if (result.isSuccess()) {
                return result.getData() != null ? result.getData() : Collections.emptyMap();
            }
            return Collections.emptyMap();
    ...
    public List<Map<String, Object>> getStoryboardsByEpisode(String episodeId) {
        ...
        try {
            Result<List<Map<String, Object>>> result = projectLocalClient.getStoryboardsByEpisode(episodeId);
            if (result.isSuccess()) {
                return limitResults(result.getData());
            }
            return Collections.emptyList();
    ...
    public Map<String, Object> createCharacter(Map<String, Object> data) {
        ...
        try {
            Result<Map<String, Object>> result = projectLocalClient.createCharacter(request);
            return buildResult(result);
        } catch (Exception e) {
    ...
    public Map<String, Object> batchCreateCharacters(List<Map<String, Object>> characters) {
        ...
        try {
            Result<List<String>> result = projectLocalClient.batchCreateCharacters(requests);
            return buildListResult(result);
        } catch (Exception e) {
    ...
    public Map<String, Object> updateCharacter(String characterId, Map<String, Object> data) {
        ...
        try {
            Result<Void> result = projectLocalClient.updateCharacter(characterId, data);
            return buildVoidResult(result);
        } catch (Exception e) {
    ...
    public Map<String, Object> deleteCharacter(String characterId) {
        ...
        try {
            Result<Void> result = projectLocalClient.deleteCharacter(characterId);
            return buildVoidResult(result);
        } catch (Exception e) {
    ...
    public Map<String, Object> batchDeleteCharacters(List<String> characterIds) {
        ...
        try {
            Result<Void> result = projectLocalClient.batchDeleteCharacters(characterIds);
            return buildVoidResult(result);
        } catch (Exception e) {
    ...
    public Map<String, Object> getCharacter(String characterId) {
        ...
        try {
            Result<Map<String, Object>> result = projectLocalClient.getCharacter(characterId);
            if (result.isSuccess()) {
                return result.getData() != null ? result.getData() : Collections.emptyMap();
            }
            return Collections.emptyMap();
    ...
    public List<Map<String, Object>> getCharactersByScript(String scriptId) {
        ...
        try {
            Result<List<Map<String, Object>>> result = projectLocalClient.getCharactersByScript(scriptId);
            if (result.isSuccess()) {
                return limitResults(result.getData());
            }
    ...
    public Map<String, Object> createScene(Map<String, Object> data) {
        ...
        try {
            Result<Map<String, Object>> result = projectLocalClient.createScene(request);
            return buildResult(result);
        } catch (Exception e) {
    ...
    public Map<String, Object> batchCreateScenes(List<Map<String, Object>> scenes) {
        ...
        try {
            Result<List<String>> result = projectLocalClient.batchCreateScenes(requests);
            return buildListResult(result);
        } catch (Exception e) {
    ...
    public Map<String, Object> updateScene(String sceneId, Map<String, Object> data) {
        ...
        try {
            Result<Void> result = projectLocalClient.updateScene(sceneId, data);
            return buildVoidResult(result);
        } catch (Exception e) {
    ...
    public Map<String, Object> deleteScene(String sceneId) {
        ...
        try {
            Result<Void> result = projectLocalClient.deleteScene(sceneId);
            return buildVoidResult(result);
        } catch (Exception e) {
    ...
    public Map<String, Object> batchDeleteScenes(List<String> sceneIds) {
        ...
        try {
            Result<Void> result = projectLocalClient.batchDeleteScenes(sceneIds);
            return buildVoidResult(result);
        } catch (Exception e) {
    ...
    public Map<String, Object> getScene(String sceneId) {
        ...
        try {
            Result<Map<String, Object>> result = projectLocalClient.getScene(sceneId);
            if (result.isSuccess()) {
                return result.getData() != null ? result.getData() : Collections.emptyMap();
            }
            return Collections.emptyMap();
    ...
    public List<Map<String, Object>> getScenesByScript(String scriptId) {
        ...
        try {
            Result<List<Map<String, Object>>> result = projectLocalClient.getScenesByScript(scriptId);
            if (result.isSuccess()) {
                return limitResults(result.getData());
            }
            return Collections.emptyList();
    ...
    public Map<String, Object> createProp(Map<String, Object> data) {
        ...
        try {
            Result<Map<String, Object>> result = projectLocalClient.createProp(request);
            return buildResult(result);
        } catch (Exception e) {
    ...
    public Map<String, Object> batchCreateProps(List<Map<String, Object>> props) {
        ...
        try {
            Result<List<String>> result = projectLocalClient.batchCreateProps(requests);
            return buildListResult(result);
        } catch (Exception e) {
    ...
    public Map<String, Object> updateProp(String propId, Map<String, Object> data) {
        ...
        try {
            Result<Void> result = projectLocalClient.updateProp(propId, data);
            return buildVoidResult(result);
        } catch (Exception e) {
    ...
    public Map<String, Object> deleteProp(String propId) {
        ...
        try {
            Result<Void> result = projectLocalClient.deleteProp(propId);
            return buildVoidResult(result);
        } catch (Exception e) {
    ...
    public Map<String, Object> batchDeleteProps(List<String> propIds) {
        ...
        try {
            Result<Void> result = projectLocalClient.batchDeleteProps(propIds);
            return buildVoidResult(result);
        } catch (Exception e) {
    ...
    public Map<String, Object> getProp(String propId) {
        ...
        try {
            Result<Map<String, Object>> result = projectLocalClient.getProp(propId);
            if (result.isSuccess()) {
                return result.getData() != null ? result.getData() : Collections.emptyMap();
            }
            return Collections.emptyMap();
    ...
    public List<Map<String, Object>> getPropsByScript(String scriptId) {
        ...
        try {
            Result<List<Map<String, Object>>> result = projectLocalClient.getPropsByScript(scriptId);
            if (result.isSuccess()) {
                return limitResults(result.getData());
            }
            return Collections.emptyList();
    ...
    public Map<String, Object> createStyle(Map<String, Object> data) {
        ...
        try {
            Result<Map<String, Object>> result = projectLocalClient.createStyle(request);
            return buildResult(result);
        } catch (Exception e) {
    ...
    public Map<String, Object> batchCreateStyles(List<Map<String, Object>> styles) {
        ...
        try {
            Result<List<String>> result = projectLocalClient.batchCreateStyles(requests);
            return buildListResult(result);
        } catch (Exception e) {
    ...
    public Map<String, Object> updateStyle(String styleId, Map<String, Object> data) {
        ...
        try {
            Result<Void> result = projectLocalClient.updateStyle(styleId, data);
            return buildVoidResult(result);
        } catch (Exception e) {
    ...
    public Map<String, Object> deleteStyle(String styleId) {
        ...
        try {
            Result<Void> result = projectLocalClient.deleteStyle(styleId);
            return buildVoidResult(result);
        } catch (Exception e) {
    ...
    public Map<String, Object> batchDeleteStyles(List<String> styleIds) {
        ...
        try {
            Result<Void> result = projectLocalClient.batchDeleteStyles(styleIds);
            return buildVoidResult(result);
        } catch (Exception e) {
    ...
    public Map<String, Object> getStyle(String styleId) {
        ...
        try {
            Result<Map<String, Object>> result = projectLocalClient.getStyle(styleId);
            if (result.isSuccess()) {
                return result.getData() != null ? result.getData() : Collections.emptyMap();
            }
            return Collections.emptyMap();
    ...
    public List<Map<String, Object>> getStylesByScript(String scriptId) {
        ...
        try {
            Result<List<Map<String, Object>>> result = projectLocalClient.getStylesByScript(scriptId);
            if (result.isSuccess()) {
                return limitResults(result.getData());
            }
            return Collections.emptyList();
    ...
    public Map<String, Object> createAsset(Map<String, Object> data) {
        ...
        try {
            Result<Map<String, Object>> result = projectLocalClient.createAsset(request);
            return buildResult(result);
        } catch (Exception e) {
    ...
    public Map<String, Object> batchCreateAssets(List<Map<String, Object>> assets) {
        ...
        try {
            Result<List<String>> result = projectLocalClient.batchCreateAssets(requests);
            return buildListResult(result);
        } catch (Exception e) {
    ...
    public Map<String, Object> updateAsset(String assetId, Map<String, Object> data) {
        ...
        try {
            Result<Void> result = projectLocalClient.updateAsset(assetId, data);
            return buildVoidResult(result);
        } catch (Exception e) {
    ...
    public Map<String, Object> deleteAsset(String assetId) {
        ...
        try {
            Result<Void> result = projectLocalClient.deleteAsset(assetId);
            return buildVoidResult(result);
        } catch (Exception e) {
    ...
    public Map<String, Object> batchDeleteAssets(List<String> assetIds) {
        ...
        try {
            Result<Void> result = projectLocalClient.batchDeleteAssets(assetIds);
            return buildVoidResult(result);
        } catch (Exception e) {
    ...
    public Map<String, Object> getAsset(String assetId) {
        ...
        try {
            Result<Map<String, Object>> result = projectLocalClient.getAsset(assetId);
            if (result.isSuccess()) {
                return result.getData() != null ? result.getData() : Collections.emptyMap();
            }
            return Collections.emptyMap();
    ...
    public List<Map<String, Object>> getAssetsByScript(String scriptId) {
        ...
        try {
            Result<List<Map<String, Object>>> result = projectLocalClient.getAssetsByScript(scriptId);
            if (result.isSuccess()) {
                return limitResults(result.getData());
            }
            return Collections.emptyList();
    ...
    public List<Map<String, Object>> listAssets(String assetType) {
        ...
        try {
            Result<List<Map<String, Object>>> result = projectLocalClient.listAssets(workspaceId, assetType);
            if (result.isSuccess()) {
                return limitResults(result.getData());
            }
            return Collections.emptyList();
    ...
    public Map<String, Object> updateAssetGenerationStatus(String assetId, String status, String errorMessage) {
        ...
        try {
            Result<Void> result = projectLocalClient.updateAssetGenerationStatus(assetId, status, errorMessage);
            return buildVoidResult(result);
        } catch (Exception e) {
    ...
    public Map<String, Object> updateAssetFileInfo(String assetId, Map<String, Object> fileInfo) {
        ...
        try {
            Result<Void> result = projectLocalClient.updateAssetFileInfo(assetId, fileInfo);
            return buildVoidResult(result);
        } catch (Exception e) {
