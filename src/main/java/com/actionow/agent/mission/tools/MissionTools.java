...
public class MissionTools {
    ...
    public Map<String, Object> delegateScopeGeneration(
        ...
        try {
            ...
            Result<Map<String, Object>> batchResult = taskLocalClient.createBatchJob(workspaceId, userId, batchRequest);
    ...
    public Map<String, Object> delegateBatchGeneration(
        ...
        try {
            ...
            try {
                ...
                Result<Boolean> quotaResult = walletLocalClient.checkQuota(workspaceId, userId, totalEstimate);
