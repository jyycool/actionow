...
public class ContextAugmentationService {
     ...
     * 从 AgentContext 获取锚点 ID，通过 Local + 缓存解析名称。
     */
    ...
    private void appendEntitySummary(StringBuilder sb, String scriptId) {
        try {
            ...
            appendEntityCount(entitySummary, "角色",
                    projectLocalClient.queryCharacters(null, scriptId, null, null, null, 1, 1, null, null));
            appendEntityCount(entitySummary, "场景",
                    projectLocalClient.queryScenes(null, scriptId, null, null, 1, 1, null, null));
            appendEntityCount(entitySummary, "道具",
                    projectLocalClient.queryProps(null, scriptId, null, null, 1, 1, null, null));
