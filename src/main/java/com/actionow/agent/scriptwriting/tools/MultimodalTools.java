...
public class MultimodalTools {
    ...
    public Map<String, Object> getAsset(
        ...
        try {
            Result<Map<String, Object>> result = assetLocalClient.getAsset(workspaceId, assetId);
    ...
    public Map<String, Object> batchGetAssets(
        ...
        try {
            Result<List<Map<String, Object>>> result = assetLocalClient.batchGetAssets(assetIds);
    ...
    public Map<String, Object> getEntityAssets(
        ...
        try {
            Result<List<Map<String, Object>>> result = assetLocalClient.getEntityAssets(
    ...
    public Map<String, Object> getEntityAssetsByType(
        ...
        try {
            Result<List<Map<String, Object>>> result = assetLocalClient.getEntityAssetsByType(
    ...
    public Map<String, Object> queryAssets(
        ...
        try {
            Result<Map<String, Object>> result = projectLocalClient.queryAssets(
    ...
    public Map<String, Object> updateAsset(
        ...
        try {
            Result<Map<String, Object>> result = projectLocalClient.updateAsset(assetId, request);
    ...
    public Map<String, Object> listAiProviders(
        ...
        try {
            Result<List<AvailableProviderResponse>> result = aiLocalClient.getAvailableProviders(providerType.toUpperCase());
    ...
    public Map<String, Object> getAiProviderDetail(
        ...
        try {
            Result<AvailableProviderResponse> result = aiLocalClient.getProviderDetail(providerId);
    ...
    private Map<String, Object> performAssetDelete(List<String> ids, String workspaceId, String userId) {
        ...
        for (String id : ids) {
            try {
                Result<Void> r = assetLocalClient.deleteAsset(workspaceId, userId, id);
                if (r != null && r.isSuccess()) {
                    deleted.add(id);
                } else {
                    Map<String, Object> entry = new HashMap<>();
                    entry.put("id", id);
                    entry.put("reason", r != null ? r.getMessage() : "Local 返回 null");
                    failed.add(entry);
                }
            } catch (Exception e) {
                Map<String, Object> entry = new HashMap<>();
