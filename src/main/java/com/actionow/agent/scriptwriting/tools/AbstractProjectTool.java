...
public abstract class AbstractProjectTool {
    ...
    protected final ProjectLocalClient projectClient;
    ...
    protected AbstractProjectTool(ProjectLocalClient projectClient, ScopeValidator scopeValidator) {
        this.projectClient = projectClient;
        this.scopeValidator = scopeValidator;
        this.hitl = null;
    }

    protected AbstractProjectTool(ProjectLocalClient projectClient) {
        this.projectClient = projectClient;
    ...
    protected AbstractProjectTool(ProjectLocalClient projectClient, HitlConfirmationHelper hitl) {
        this.projectClient = projectClient;
        this.scopeValidator = null;
        this.hitl = hitl;
    }
    ...
    /**
     * 处理 Local 返回的 Result 对象
     * @param result Local 调用返回的结果
     ...
     * @param deleter    单项删除函数，通常是 Local 方法引用，如 {@code projectClient::deleteCharacter}
     */
     ...
     * @param deleter 单项删除函数，返回 Local {@link Result}
